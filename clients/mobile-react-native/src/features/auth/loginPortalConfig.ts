...
export const MOBILE_LOGIN_PORTALS: LoginPortalUiConfig[] = [
  ...
  },
  {
    ...
    subtitle: 'Danışan sohbetlerinizi yönetin, yanıt verin ve ürün teklifleri gönderin.',
    features: ['Danışan sohbetleri', 'Ürün teklifleri', 'Randevu listesi'],
    emailPlaceholder: 'danisman.ali@terravision.com',
    submitLabel: 'Danışman olarak giriş yap',
    defaultEmail: 'danisman.ali@terravision.com',
