...
export const API_ROUTES = {
  ...
  ordersMeById: (orderId: number) => `${API_PATH_PREFIX}/orders/me/${orderId}`,
  ...
  careCatalogPlants: `${API_PATH_PREFIX}/care/catalog-plants`,
  careAddToGarden: `${API_PATH_PREFIX}/care/my-garden`,
  careCompleteAction: (calendarId: number) =>
    `${API_PATH_PREFIX}/care/${calendarId}/complete-action`,
  careAssistantChat: `${API_PATH_PREFIX}/care/assistant/chat`,
  usersAdmin: `${API_PATH_PREFIX}/users`,
